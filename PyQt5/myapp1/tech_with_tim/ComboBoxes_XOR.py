...
# set default
index = self.comboX.findText(
    "1", QtCore.QtMatchFixedString
)  # finds the index of the item you want
self.comboX.setCurrentIndex(
    index
)  # sets the index (you can also just put an integer for the variable index)
...
class Ui_MainWindow(object):
    ...
    def pressed(self):  # xor fuction,changing to int
        ...
        self.label.setText("X XOR Y =  " + str(xor))  # adding label to text
